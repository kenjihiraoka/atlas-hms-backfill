...
for i in "${BASEDIR}/hive/atlas-hive-plugin-impl/"*.jar; do
...
elif [ ! -z "$METASTORE_HOME" ]; then
    HIVE_CONF="$METASTORE_HOME/conf"
...
-Dlog4j.configuration=/opt/atlas/hook/hive/atlas-hive-import-log4j.xml"
